...
namespace DelayTaskLib
{
    ...
    public class DelayTaskConfig
    {
        ...
        /// <returns></returns>
        public static DelayTaskConfig NewLoopTaskConfig(Guid id, int delaySeconds, string taskType, string description, int loopInterval)
        {
            return new DelayTaskConfig
            {
                ID = id,
        ...
        /// <returns></returns>
        public static DelayTaskConfig NewUnloopTaskConfig(Guid id, int delaySeconds, string taskType, string description, int maxTryTime = 0, int tryInterval = 0)
        {
            return new DelayTaskConfig
            {
                ID = id,
